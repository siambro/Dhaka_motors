	...
	<section class="content">
      <div class="row">
					 ...
					 $con=mysqli_connect('localhost','root','','dhaka_motors');
						...
						if(mysqli_num_rows($result)>0){
							while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
								echo "<tr>";
								echo "<td><a href='m_edit.php?ID=".$row['ID']."'><span class='fa fa-edit'></span></a></td>";
								//echo "<td><a href=dDelete.php?discount_id=".$row['discount_id']."'><span class='fa fa-minus-circle'></span></a></td>";
								
								echo "<td><a onclick='javascript:confirmationDelete($(this));return false;' href='m_delete.php?ID=".$row['ID']."'>x</a></td>";
								
								echo "<td>".$row['miModel']."</td>";
		...
		<div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="m_manager.php" method="POST">
                <script>
										$( function() {
				...
				<div class="form-group">
                  <input type="submit" class="btn btn-flat btn-block btn-success" onclick="return confirm('Are you sure want to add?')" name="add" value="Add Model" >
                </div>
